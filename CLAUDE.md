...
- Never save working files, text files, markdown files, or tests to the root folder — use the appropriate subdirectory (`tests/`, `docs/`, `scripts/`).
- ALWAYS prefer editing existing files to creating new ones. NEVER proactively create documentation files (*.md) or README files unless explicitly requested.

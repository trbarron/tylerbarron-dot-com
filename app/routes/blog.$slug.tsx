      ...
      <div className="py-8">
        <article className="max-w-4xl mx-auto mb-8 bg-white/95 backdrop-blur-sm px-6 lg:px-12 py-8">
          ...
          <div className="mx-auto prose prose-lg max-w-none
                          ...
                          prose-code:bg-neutral-100 prose-code:text-black prose-code:font-mono prose-code:text-[0.85em] prose-code:font-normal
                          prose-code:before:content-none prose-code:after:content-none
                          prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-sm
                          prose-pre:bg-neutral-100 prose-pre:text-black prose-pre:border-l-4 prose-pre:border-black prose-pre:font-mono prose-pre:text-sm

...
* Repeat for `2` and `n-2`, until you reach `n/2`
...
<img src="/_static/images/validCombinations.png" alt="Description" />
...
This helped us compute solutions up to 500 on a laptop after several days of computation. I suspect there must be a more efficient way, although I could not come up with it.

I have made the code used for this available [here](github.com) in case others would like to view or improve it

## Conclusion
While we couldn't directly solve for 2025, our investigation led us to [sequence A261153 in the OEIS](https://oeis.org/A261153) which appears to be very similar.

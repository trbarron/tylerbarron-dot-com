...
This worked and helped me find some interesting oversights in my code. The problem was scale. In my small app, [cat tracker](/cat-tracker), there were 468 mutants, of which 156 survived. This was too much to manually investigate.
...
The [script](https://github.com/trbarron/cat_finder/blob/mutation-testing/mutation_testing/analyze_survived_mutants.py) (`analyze_survived_mutants.py`) does just this. For each mutant, it

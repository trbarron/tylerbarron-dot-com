...
<video src="/images/semicircle.mp4" autoPlay loop muted playsInline aria-label="empty corridor of width 1" className="mx-auto" />
...
<video src="/images/movingSofa1.mp4" autoPlay loop muted playsInline aria-label="example solution" />

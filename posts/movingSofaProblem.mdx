...
<video src="/images/posts/movingSofaProblem/semicircle.mp4" autoPlay loop muted playsInline aria-label="empty corridor of width 1" className="mx-auto" />
...
<video src="/images/posts/movingSofaProblem/movingSofa1.mp4" autoPlay loop muted playsInline aria-label="example solution" />

This was the most fun portion of the project -- tweaking parameters and seeing the result was really the output I was hoping for. [Feel free to play with it yourself, the code can be found here](https://github.com/trbarron/moving-sofa-problem). Some of the solutions got close to the maximum known answer of 2.2195, but none surpassed it
